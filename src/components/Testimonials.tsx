export const Testimonials = () => {
  const testimonials = [
    ...
    },
    {
      ...
      content:
        "Place exceeded my expectations on all fronts. The ambiance was cozy and sweet, making it a perfect venue for our anniversary dinner. Each dish was prepared and beautifully presented.",
      author: "Matt Cannon",
    ...
    },
    {
      ...
      content:
        "The culinary experience at place is next to none, the atmosphere is vibrant, the food - nothing short of extraordinary. The food was the highlight of our evening. Highly recommended!",
      author: "Andy Smith",
