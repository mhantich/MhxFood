...
function AboutInfo() {
  const features = [
    { title: "Online Services Available",description:"Our visual designer lets you quickly and of drag a down your way to" },
    { title: "Online Services Available",description:"Our visual designer lets you quickly and of drag a down your way to" },
    { title: "Online Services Available",description:"Our visual designer lets you quickly and of drag a down your way to" },
    { title: "Online Services Available",description:"Our visual designer lets you quickly and of drag a down your way to" },
  ];
        ...
        <div className="md:w-1/2 space-y-8">
          ...
          <ul className=" grid grid-cols-1 md:grid-cols-2 gap-4">
            {features.map((feature, index) => (
              <div key={index} className="flex bg-gray-200/40 p-2 items-center gap-2">
